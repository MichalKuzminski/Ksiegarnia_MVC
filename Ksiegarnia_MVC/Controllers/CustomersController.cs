...
namespace Ksiegarnia_MVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(Ksiegarnia_MVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customer != null ? 
                          ...
                          Problem("Entity set 'Ksiegarnia_MVCContext.Customer'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName")] Customer customer)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Wchodzi");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Ksiegarnia_MVCContext.Customer'  is null.");
            }
            var customer = await _context.Customer.FindAsync(id);
            if (customer != null)
            {
